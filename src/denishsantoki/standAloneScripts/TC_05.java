...
public class TC_05 {
	...
	void verifyFilter() {
		...
		System.out.println("STEP: User entered name as Denish");
		waitForElementTobeVisible(By.xpath("//div[@class = 'field']/input[@class='input txt']")).sendKeys("Denish");

		System.out.println("STEP : User Select Country");
		...
		System.out.println("STEP: Validate THANKYOU FOR THE ORDER Title Displayed");
		Assert.assertTrue(driver.findElement(By.xpath("//h1[@class='hero-primary']")).isDisplayed(), "Title is not displayed");
	}
