...
public class Assignment5 {
	...
	public static void main(String[] args) {
		...
		WebElement javascriptBtn = driver.findElement(By.xpath("//button[@id='javascriptConfirmBox']"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true)", javascriptBtn);
		javascriptBtn.click();
		...
		if (alertText.endsWith(alertText)) {
