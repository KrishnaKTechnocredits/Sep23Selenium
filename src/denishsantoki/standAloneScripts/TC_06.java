...
public class TC_06 {
	...
	void verifyFilter() {
		...
		System.out.println("STEP : Navigate To Order Tab");
		waitForElementTobeVisible(By.xpath("//button[@routerlink='/dashboard/myorders']")).click();
		
		waitUntilLoaderDisappers();
		
		System.out.println("STEP : Verify Product IS Displayed in Order Tab");
		String orderLocator = String.format("//td[text()='%s']", selectProduct);
