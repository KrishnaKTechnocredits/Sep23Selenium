...
public class Assignment35 {
	...
	public void verifyLogin() throws InterruptedException {
		...
		waitForElementTobeVisible(By.xpath("//input[@class='input txt']")).sendKeys("Sayali");
		...
		System.out.println("STEP: Validate that \"THANKYOU FOR THE ORDER.\" title displayed");
		driver.findElement(By.xpath("//h1[@class='hero-primary']"));
