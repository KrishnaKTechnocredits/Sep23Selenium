...
public class Assignment09 {
	...
	public void fbRegistration() {
		...
		tempWait(5000);
		Select customGender = new Select(dr.findElement(By.xpath("//select[@aria-label='Select your pronoun']")));
		customGender.selectByValue("2");

		System.out.println("All the mentioned values selected with Gender as \"Custom\"!");
	}

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Assignment09 output = new Assignment09();
