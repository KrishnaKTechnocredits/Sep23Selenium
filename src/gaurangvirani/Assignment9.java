...
public class Assignment9 {
	...
	void custom() {
		...
		Select se1 = new Select(driver.findElement(By.xpath("//select[@name='preferred_pronoun']")));
		se1.selectByValue("2");
		
		System.out.println("Enter Gender");
		driver.findElement(By.xpath("//input[@name='custom_gender']")).sendKeys("Custom male");
		
		driver.close();
	}
	
	public static void main(String[] args) {
		new Assignment9().custom();
	}
}