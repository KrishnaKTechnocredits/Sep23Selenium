...
public class TC7 {
	...
	void verifyToastMessage() {
		...
		driver.findElement(By.id("userEmail")).sendKeys("pushpa.gite1209@gmail.com");
		...
		System.out.println("STEP : User entered name");
		waitForElementTobeVisible(By.xpath("//div[@class = 'field']/input[@class='input txt']")).sendKeys("Pushpa");
