package technocredits.datadriven;
...
import technocredits.utility.ExcelOperations;
...
public class RegistrationDataDrivenTest {
	...
	public Object[][] loginDataProvider() throws IOException {
		/*
		 * try { Object[][] data =
		 * ExcelOperations.getAllRows(".//testdata/LoginData.xlsx", "Data"); return
		 * data; }catch(IOException ie) { Object[][] data =
		 * ExcelOperations.getAllRows(".//backup/LoginData.xlsx", "Data"); return data;
		 * }
		 */
