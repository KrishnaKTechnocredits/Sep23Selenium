...
9. user validate "No Products in Your Cart !" Message displayed on cart page */
...
public class Assignment37_TC09 {
	...
	void verifyFilter() {
		...
		for (WebElement singleDeletebutton : listOfbutton) {
			singleDeletebutton.click();
			}

		System.out.println("VERIFY: 'No product in Your Cart' toast message");
		WebElement toastMessage = waitForElementTobeVisible(
				By.xpath("//div[@id='toast-container']//div[contains(text(), 'No Product in Your Cart')]"));
		Assert.assertTrue(toastMessage.isDisplayed(), "Toast message not displayed");

		System.out.println("VERIFY: 'No Products in Your Cart !' Message displayed on cart page");
